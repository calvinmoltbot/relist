...
// ---------------------------------------------------------------------------
// Dashboard view — receives server-rendered data as a prop. No useEffect
// fetch, no skeleton-then-fetch flicker. The old client-fetch path still
// exists at /api/dashboard for future refresh-on-mutation use cases.
// ---------------------------------------------------------------------------
